...
%temperature across all cases using the discrepancy theorem
...
%loop to solve 100 different noise cases for the defective lattice
 for j=1:100
    ...
    %discrepancy for a given noise
    [scaled_noise_norm ,key_idx, bestSol ] = ....
     errFunc_discrepancy_solve(mInt,mb,h,elements,Dmat,Gmat, dub, dfb,ub0,fb0,gg_values,normals,msMinus,msPlus, muTarget,iter_idx);
    ...
    %record if the current case predicted the correct defective bar
...
title("Number of predicted bars vs Case Normalized Noise Norm: Single defective bar // Discrepancy", 'FontSize', 12)
